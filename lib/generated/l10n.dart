...
class S {
  ...
  String get lecturers {
    return Intl.message('Lecturers', name: 'lecturers', desc: '', args: []);
  }
  ...
  String get completeTheSubscriptionProcess {
    return Intl.message(
      'Complete the subscription process',
      name: 'completeTheSubscriptionProcess',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Abilities Course`
  String get abilitiesCourse {
    return Intl.message(
      'Abilities Course',
      name: 'abilitiesCourse',
      desc: '',
      args: [],
    );
  }
  ...
  /// `The Lesson`
  String get theLesson {
    return Intl.message('The Lesson', name: 'theLesson', desc: '', args: []);
  }
  ...
  String get abilities {
    return Intl.message('The Abilities', name: 'abilities', desc: '', args: []);
  }
}
